...
KEFU.init = function (config) {
  ...
  this.dynamicLoadCss(
    this.KEFU_URL + "/static/css/kefu-front.css?v=" + Date.now()
  );
  this.dynamicLoadCss(
    this.KEFU_URL + "/static/css/layui/css/layui.css?v=" + Date.now()
  );
  ...
  this.dynamicLoadJs(
    this.KEFU_URL + "/static/js/functions.js?v=1",
    function () {
      _this.dynamicLoadJs(
        ...
        function () {
          jQuery.noConflict();
          _this.dynamicLoadJs(
            _this.KEFU_URL + "/static/js/layer/layer.js",
            function () {
              _this.jsCallBack();
            }
          );
...
KEFU.postToIframe = function (messageObj) {
  ...
  document
    .getElementById("layui-layer-iframe19911116")
    .contentWindow.postMessage(messageObj, "*");
};
KEFU.addEventlisten = function () {
  ...
  window.addEventListener("message", function (e) {
    ...
    if (msg.type == "message") {
      ...
      var welcomeHtml =
        "<div id='launchNoticeClose' class='flyClose'>×</div>" +
        "<div class='flexBox'><div class='flyUser'><img class='flyAvatar' src='" +
        _this.kefuAvator +
        "'/>" +
        "</div>" +
...
KEFU.layerOpen = function (width, height, offset) {
  ...
  var title =
    ...
    <div class="kfBar">
        <div class="kfBarAvator">
            <img src="` +
    this.KEFU_URL +
    `/static/images/4.jpg" class="kfBarLogo">
  ...
  kayer.open({
    ...
    success: function (layero, index) {
      ...
      if (
        !_this.KEFU_WITHOUT_BOX &&
        _this.KEFU_AUTO_SHOW &&
